...
def gemini_request_single_json(article_text, max_retries=MAX_RETRIES, base_delay=BASE_RETRY_DELAY):
    ...
    prompt = (
        ...
        "2) Создай краткую выжимку на русском (5-7 предложений; разделяй на абзацы, если уместно; максимум 4000 символов) — поле summary_ru.\n"
        "3) Подбери 3-4 хэштега по содержанию (без пробелов, с #) — поле hashtags (массив строк).\n\n"
